      ...
      <form #f="ngForm" (ngSubmit)="logUser(f.value, f.invalid)">
        ...
        <mat-form-field appearance="fill" class="w-100 mb-3">
          ...
          <mat-error *ngIf="password.touched && password.errors?.minlength">
            ...
            Inserire altri {{ password.errors?.minlength.requiredLength - password.errors?.minlength.actualLength }} caratteri
          </mat-error>
          <mat-error *ngIf="email.touched && email.errors?.required">Questo campo è obbligatorio</mat-error>
        </mat-form-field>
        ...
        <button
          ...
          [disabled]="f.invalid"
        >Accedi</button>
        <a mat-button color="accent" class="mt-2 ps-0">Crea un nuovo account</a>
      </form>
    </mat-card>
  `,
  styles: [`
